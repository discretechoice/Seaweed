...
# Estimating a hybrid choice model for England
...
bsc_age        = Beta('bsc_age       ',0.00542773,-10000,10000,0,'bsc_age       ' )
bsc_female     = Beta('bsc_female    ',0.027664,-10000,10000,0,'bsc_female    ' )
bsc_cohabit    = Beta('bsc_cohabit   ',0.0571099,-10000,10000,0,'bsc_cohabit   ' )
bsc_numchild   = Beta('bsc_numchild  ',-0.0775936,-10000,10000,0,'bsc_numchild  ' )
bsc_higheduc   = Beta('bsc_higheduc  ',-0.209717,-10000,10000,0,'bsc_higheduc  ' )
bsc_employed   = Beta('bsc_employed  ',-0.0519571,-10000,10000,0,'bsc_employed  ' )
bsc_green      = Beta('bsc_green     ',-0.867719,-10000,10000,0,'bsc_green     ' )
bsc_polorient  = Beta('bsc_polorient ',-0.00800185,-10000,10000,0,'bsc_polorient ' )
bsc_highincome = Beta('bsc_highincome',-0.00470152,-10000,10000,0,'bsc_highincome' )
...
# VARIABLE 1LVEnv
tau1LVEnv1 = Beta('tau1LVEnv1',-0.40823,-10000,10000,0,'tau1LVEnv1' )
delta1LVEnv2 = Beta('delta1LVEnv2',4.30536,0,10000,0,'delta1LVEnv2' )
delta1LVEnv3 = Beta('delta1LVEnv3',2.25888,0,10000,0,'delta1LVEnv3' )
alpha1LVEnv = Beta('alpha1LVEnv',2.03396,-100,100,0,'alpha1LVEnv' )
...
# VARIABLE 2LVEnv
tau2LVEnv1 = Beta('tau2LVEnv1',-2.06133,-10000,10000,0,'tau2LVEnv1' )
delta2LVEnv2 = Beta('delta2LVEnv2',3.37559,0,10000,0,'delta2LVEnv2' )
delta2LVEnv3 = Beta('delta2LVEnv3',3.50322,0,10000,0,'delta2LVEnv3' )
alpha2LVEnv = Beta('alpha2LVEnv',1.93633,-100,100,0,'alpha2LVEnv' )
...
# VARIABLE 3LVEnv
tau3LVEnv1 = Beta('tau3LVEnv1',-0.997143,-10000,10000,0,'tau3LVEnv1' )
delta3LVEnv2 = Beta('delta3LVEnv2',2.62907,0,10000,0,'delta3LVEnv2' )
delta3LVEnv3 = Beta('delta3LVEnv3',3.27481,0,10000,0,'delta3LVEnv3' )
alpha3LVEnv = Beta('alpha3LVEnv',1.03891,-100,100,0,'alpha3LVEnv' )
...
# VARIABLE 4LVEnv
tau4LVEnv1 = Beta('tau4LVEnv1',-1.45388,-10000,10000,0,'tau4LVEnv1' )
delta4LVEnv2 = Beta('delta4LVEnv2',2.61676,0,10000,0,'delta4LVEnv2' )
delta4LVEnv3 = Beta('delta4LVEnv3',2.9217,0,10000,0,'delta4LVEnv3' )
alpha4LVEnv = Beta('alpha4LVEnv',1.10028,-100,100,0,'alpha4LVEnv' )
...
# VARIABLE 5LVEnv
tau5LVEnv1 = Beta('tau5LVEnv1',-2.21568,-10000,10000,0,'tau5LVEnv1' )
delta5LVEnv2 = Beta('delta5LVEnv2',3.70962,0,10000,0,'delta5LVEnv2' )
delta5LVEnv3 = Beta('delta5LVEnv3',2.6268,0,10000,0,'delta5LVEnv3' )
alpha5LVEnv = Beta('alpha5LVEnv',1.75329,-100,100,0,'alpha5LVEnv' )
...
# VARIABLE 6LVEnv
tau6LVEnv1 = Beta('tau6LVEnv1',-0.551942,-10000,10000,0,'tau6LVEnv1' )
delta6LVEnv2 = Beta('delta6LVEnv2',3.20906,0,10000,0,'delta6LVEnv2' )
delta6LVEnv3 = Beta('delta6LVEnv3',2.3356,0,10000,0,'delta6LVEnv3' )
alpha6LVEnv = Beta('alpha6LVEnv',1.28299,-100,100,0,'alpha6LVEnv' )
...
# VARIABLE 7LVEnv
tau7LVEnv1 = Beta('tau7LVEnv1',0.295967,-10000,10000,0,'tau7LVEnv1' )
delta7LVEnv2 = Beta('delta7LVEnv2',2.74747,0,10000,0,'delta7LVEnv2' )
delta7LVEnv3 = Beta('delta7LVEnv3',1.97954,0,10000,0,'delta7LVEnv3' )
alpha7LVEnv = Beta('alpha7LVEnv',0.568942,-100,100,0,'alpha7LVEnv' )
...
ASC1 = Beta('ASC1',0.0680918,-100,100,0,'ASC1' )
ASC3 = Beta('ASC3',-2.93518,-100,100,0,'ASC3' )

bbATTR1hh2 = Beta('bbATTR1hh2',0.64634,-100,100,0,'bbATTR1hh2' )
bbATTR1LVEnvhh2     = Beta('bbATTR1LVEnvhh2    ',-0.0218752,-100,100,0,'bbATTR1LVEnvhh2    ' )
bbATTR1hh3 = Beta('bbATTR1hh3',0.969991,-100,100,0,'bbATTR1hh3' )
bbATTR1LVEnvhh3     = Beta('bbATTR1LVEnvhh3    ',-0.117831,-100,100,0,'bbATTR1LVEnvhh3    ' )
bbATTR2coast2 = Beta('bbATTR2coast2',-0.154534,-100,100,0,'bbATTR2coast2' )
bbATTR2LVEnvcoast2  = Beta('bbATTR2LVEnvcoast2 ',0.0368298,-100,100,0,'bbATTR2LVEnvcoast2 ' )
bbATTR2coast3 = Beta('bbATTR2coast3',-0.414977,-100,100,0,'bbATTR2coast3' )
bbATTR2LVEnvcoast3  = Beta('bbATTR2LVEnvcoast3 ',-0.0904912,-100,100,0,'bbATTR2LVEnvcoast3 ' )
bbATTR3cost = Beta('bbATTR3cost',-3.52552,-100,100,0,'bbATTR3cost' )
bbATTR3LVEnvcost    = Beta('bbATTR3LVEnvcost   ',0.687472,-100,100,0,'bbATTR3LVEnvcost   ' )
bbATTR4perk1 = Beta('bbATTR4perk1',0.0134434,-100,100,0,'bbATTR4perk1' )
bbATTR4LVEnvperk1   = Beta('bbATTR4LVEnvperk1  ',0.00402822,-100,100,0,'bbATTR4LVEnvperk1  ' )
bbATTR4perk2 = Beta('bbATTR4perk2',-0.206347,-100,100,0,'bbATTR4perk2' )
bbATTR4LVEnvperk2   = Beta('bbATTR4LVEnvperk2  ',-0.00362276,-100,100,0,'bbATTR4LVEnvperk2  ' )

sdbATTR1hh2 = Beta('sdbATTR1hh2',-0.134361,-100,100,0,'sdbATTR1hh2' )
sdbATTR1hh3 = Beta('sdbATTR1hh3',1.03022,-100,100,0,'sdbATTR1hh3' )
sdbATTR2coast2 = Beta('sdbATTR2coast2',-0.529045,-100,100,0,'sdbATTR2coast2' )
sdbATTR2coast3 = Beta('sdbATTR2coast3',-1.03508,-100,100,0,'sdbATTR2coast3' )
sdbATTR3cost = Beta('sdbATTR3cost',1.56528,-100,100,0,'sdbATTR3cost' )
sdbATTR4perk1 = Beta('sdbATTR4perk1',0.309358,-100,100,0,'sdbATTR4perk1' )
sdbATTR4perk2 = Beta('sdbATTR4perk2',0.390516,-100,100,0,'sdbATTR4perk2' )
