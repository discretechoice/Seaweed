...
# Estimating a hybrid choice model for Scotland
...
bsc_age        = Beta('bsc_age       ',-0.00110792,-10000,10000,0,'bsc_age       ' )
bsc_female     = Beta('bsc_female    ',-0.246663,-10000,10000,0,'bsc_female    ' )
bsc_cohabit    = Beta('bsc_cohabit   ',-0.119153,-10000,10000,0,'bsc_cohabit   ' )
bsc_numchild   = Beta('bsc_numchild  ',-0.0171958,-10000,10000,0,'bsc_numchild  ' )
bsc_higheduc   = Beta('bsc_higheduc  ',0.0474343,-10000,10000,0,'bsc_higheduc  ' )
bsc_employed   = Beta('bsc_employed  ',0.0496618,-10000,10000,0,'bsc_employed  ' )
bsc_green      = Beta('bsc_green     ',-0.904055,-10000,10000,0,'bsc_green     ' )
bsc_polorient  = Beta('bsc_polorient ',0.100482,-10000,10000,0,'bsc_polorient ' )
bsc_highincome = Beta('bsc_highincome',-0.203354,-10000,10000,0,'bsc_highincome' )
...
#############################
#  Attitudinal Statments
#############################

# Defining variables for the measurement equations (starting values based on previous estimations)

# VARIABLE 1LVEnv
tau1LVEnv1 = Beta('tau1LVEnv1',0.0530493,-10000,10000,0,'tau1LVEnv1' )
delta1LVEnv2 = Beta('delta1LVEnv2',4.66861,0,10000,0,'delta1LVEnv2' )
delta1LVEnv3 = Beta('delta1LVEnv3',3.20166,0,10000,0,'delta1LVEnv3' )
alpha1LVEnv = Beta('alpha1LVEnv',2.34991,-100,100,0,'alpha1LVEnv' )
...
# VARIABLE 2LVEnv
tau2LVEnv1 = Beta('tau2LVEnv1',-1.65027,-10000,10000,0,'tau2LVEnv1' )
delta2LVEnv2 = Beta('delta2LVEnv2',3.62959,0,10000,0,'delta2LVEnv2' )
delta2LVEnv3 = Beta('delta2LVEnv3',3.76575,0,10000,0,'delta2LVEnv3' )
alpha2LVEnv = Beta('alpha2LVEnv',2.0066,-100,100,0,'alpha2LVEnv' )
...
# VARIABLE 3LVEnv
tau3LVEnv1 = Beta('tau3LVEnv1',-0.616143,-10000,10000,0,'tau3LVEnv1' )
delta3LVEnv2 = Beta('delta3LVEnv2',2.81849,0,10000,0,'delta3LVEnv2' )
delta3LVEnv3 = Beta('delta3LVEnv3',2.53874,0,10000,0,'delta3LVEnv3' )
alpha3LVEnv = Beta('alpha3LVEnv',1.08524,-100,100,0,'alpha3LVEnv' )
...
# VARIABLE 4LVEnv
tau4LVEnv1 = Beta('tau4LVEnv1',-1.30624,-10000,10000,0,'tau4LVEnv1' )
delta4LVEnv2 = Beta('delta4LVEnv2',2.88943,0,10000,0,'delta4LVEnv2' )
delta4LVEnv3 = Beta('delta4LVEnv3',2.93457,0,10000,0,'delta4LVEnv3' )
alpha4LVEnv = Beta('alpha4LVEnv',1.10267,-100,100,0,'alpha4LVEnv' )
...
# VARIABLE 5LVEnv
tau5LVEnv1 = Beta('tau5LVEnv1',-1.88736,-10000,10000,0,'tau5LVEnv1' )
delta5LVEnv2 = Beta('delta5LVEnv2',3.92927,0,10000,0,'delta5LVEnv2' )
delta5LVEnv3 = Beta('delta5LVEnv3',2.68656,0,10000,0,'delta5LVEnv3' )
alpha5LVEnv = Beta('alpha5LVEnv',1.79289,-100,100,0,'alpha5LVEnv' )
...
# VARIABLE 6LVEnv
tau6LVEnv1 = Beta('tau6LVEnv1',-0.287191,-10000,10000,0,'tau6LVEnv1' )
delta6LVEnv2 = Beta('delta6LVEnv2',3.78479,0,10000,0,'delta6LVEnv2' )
delta6LVEnv3 = Beta('delta6LVEnv3',4.21696,0,10000,0,'delta6LVEnv3' )
alpha6LVEnv = Beta('alpha6LVEnv',1.63865,-100,100,0,'alpha6LVEnv' )
...
# VARIABLE 7LVEnv
tau7LVEnv1 = Beta('tau7LVEnv1',0.404629,-10000,10000,0,'tau7LVEnv1' )
delta7LVEnv2 = Beta('delta7LVEnv2',2.90852,0,10000,0,'delta7LVEnv2' )
delta7LVEnv3 = Beta('delta7LVEnv3',2.5228,0,10000,0,'delta7LVEnv3' )
alpha7LVEnv = Beta('alpha7LVEnv',0.773156,-100,100,0,'alpha7LVEnv' )
...
ASC1 = Beta('ASC1',-0.0501647,-100,100,0,'ASC1' )
ASC3 = Beta('ASC3',-3.25045,-100,100,0,'ASC3' )

bbATTR1hh2 = Beta('bbATTR1hh2',0.733943,-100,100,0,'bbATTR1hh2' )
bbATTR1LVEnvhh2     = Beta('bbATTR1LVEnvhh2    ',-0.100341,-100,100,0,'bbATTR1LVEnvhh2    ' )
sdbATTR1hh2 = Beta('sdbATTR1hh2',-0.0538624,-100,100,0,'sdbATTR1hh2' )

bbATTR1hh3 = Beta('bbATTR1hh3',1.02353,-100,100,0,'bbATTR1hh3' )
bbATTR1LVEnvhh3     = Beta('bbATTR1LVEnvhh3    ',-0.248859,-100,100,0,'bbATTR1LVEnvhh3    ' )
sdbATTR1hh3 = Beta('sdbATTR1hh3',1.0453,-100,100,0,'sdbATTR1hh3' )

bbATTR2coast2 = Beta('bbATTR2coast2',-0.151677,-100,100,0,'bbATTR2coast2' )
bbATTR2LVEnvcoast2  = Beta('bbATTR2LVEnvcoast2 ',0.0317322,-100,100,0,'bbATTR2LVEnvcoast2 ' )
sdbATTR2coast2 = Beta('sdbATTR2coast2',0.573756,-100,100,0,'sdbATTR2coast2' )

bbATTR2coast3 = Beta('bbATTR2coast3',-0.362866,-100,100,0,'bbATTR2coast3' )
bbATTR2LVEnvcoast3  = Beta('bbATTR2LVEnvcoast3 ',0.0286695,-100,100,0,'bbATTR2LVEnvcoast3 ' )
sdbATTR2coast3 = Beta('sdbATTR2coast3',-1.33572,-100,100,0,'sdbATTR2coast3' )

bbATTR3cost = Beta('bbATTR3cost',-3.39608,-100,100,0,'bbATTR3cost' )
bbATTR3LVEnvcost    = Beta('bbATTR3LVEnvcost   ',0.398177,-100,100,0,'bbATTR3LVEnvcost   ' )
sdbATTR3cost = Beta('sdbATTR3cost',1.54779,-100,100,0,'sdbATTR3cost' )

bbATTR4perk1 = Beta('bbATTR4perk1',-0.140905,-100,100,0,'bbATTR4perk1' )
bbATTR4LVEnvperk1   = Beta('bbATTR4LVEnvperk1  ',-0.0318109,-100,100,0,'bbATTR4LVEnvperk1  ' )
sdbATTR4perk1 = Beta('sdbATTR4perk1',-0.363764,-100,100,0,'sdbATTR4perk1' )

bbATTR4perk2 = Beta('bbATTR4perk2',-0.430994,-100,100,0,'bbATTR4perk2' )
bbATTR4LVEnvperk2   = Beta('bbATTR4LVEnvperk2  ',-0.121979,-100,100,0,'bbATTR4LVEnvperk2  ' )
sdbATTR4perk2 = Beta('sdbATTR4perk2',0.772725,-100,100,0,'sdbATTR4perk2' )
